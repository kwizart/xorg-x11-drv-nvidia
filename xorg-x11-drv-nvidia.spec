...
sed -i -e 's|__NV_VK_ICD__|%{_libdir}/libGLX_nvidia.so.0|' %{buildroot}%{_datadir}/vulkan/icd.d/nvidia_icd.%{_target_cpu}.json
...
sed -i -e 's|%{_libdir}/libGLX_nvidia.so.0|%{_nvidia_libdir}/libGL.so.1|' %{buildroot}%{_datadir}/vulkan/icd.d/nvidia_icd.%{_target_cpu}.json
touch -r nvidia_icd.json.template %{buildroot}%{_datadir}/vulkan/icd.d/nvidia_icd.%{_target_cpu}.json
%endif
